...
Mastermind.prototype.registerAlert = function(_data){

	if(_data.uStatus){

		alert("regstration completed!")

	}else{

		alert("there was a problem with the resistration")
...
Mastermind.prototype.loginPage = function(update){
	...
	var register = function(){
		...
		document.addEventListener("userRegisterStatus",mastermind.registerAlert,false);
	}
...
//----------------------------------------------------------------------------------------------------------Logic class
	...
	logic.prototype.checkGuess = function(_row){
		...
		console.log(_row,this.dificulty-1)
